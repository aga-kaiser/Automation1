...
public class T2_getText_getAttribute {
     ...
     */
        ...
        if(actualHeaderForForm.equals(LoopCampConstants.EXPECTED_HEADER_FOR_FORM)){
            System.out.println("Expected header for form: \"" + LoopCampConstants.EXPECTED_HEADER_FOR_FORM +
                    "\", matches actual header: \"" + actualHeaderForForm + "\" = Test PASSED");
        } else {
            System.out.println("Expected header for form: \"" + LoopCampConstants.EXPECTED_HEADER_FOR_FORM +
                    "\", DOES NOT match actual header: \"" + actualHeaderForForm);
        ...
        if(actualPlaceHolderForUsername.equals(LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME)){
            System.out.println("Expected placeholder for username: \"" + LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME +
                    "\", matches actual placeholder: \"" + actualPlaceHolderForUsername + "\" = Test PASSED");
        } else {
            System.out.println("Expected placeholder for username: \"" + LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME +
                    "\", DOES NOT match aplaceholder: \"" + actualPlaceHolderForUsername);
            System.err.println("TEST FAILED");
        }
