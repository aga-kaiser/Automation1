...
public class GoogleSearch {
    public static void main(String[] args) {
        ...
        if (actualURL.contains(expectedURL)) {
            System.out.println("Actual url " +  actualURL + ", matches expected url: " + expectedURL + ", => " +
                    "TEST PASS");
        } else {
            System.err.println("Actual url: " + actualURL + ", DOES NOT match expected url: " + expectedURL +
                    ", => TEST FAIL");
        }
